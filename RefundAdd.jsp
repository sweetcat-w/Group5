...
<%@ include file="navbar.jsp" %>
    <div class="content">
        <div class="header">
            <h1 class="page-title">新增退货登记</h1>
        </div>
		<div>
			<ul class="breadcrumb">
				<li><a href="GetRefundServlert">查看退货登记</a> <span class="divider">/</span></li>
				<li class="active">新增退货登记</li>
			</ul>
		</div>
        <div class="container-fluid">
 			<div class="row-fluid">     
 			<form id="refundTab" method="post" action="AddRefundServlert" >
					...
					<div id="myTabContent">					
							<ul style="list-style: none; position: relative; left: -20px; height: 200px; width:180px;">
								...
								<li style="width:180px;">
									...
									<input type="text" name="g_specifications" id="g_specifications"  class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="position: relative; top:-163px; left:240px; width:180px;">
									<label style="width: 180px;">交易单号：</label>
									<input type="text" name="transactionNo" id="transactionNo" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="position: relative; top:-163px; left:240px; width:180px;">
									<label style="width: 180px;">生产日期：</label>
									<input type="text" name=g_manufactureDate id="g_manufactureDate" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="position: relative; top:-163px; left:240px; width:180px;">
									<label style="width: 180px;">退货数量：</label>
									<input type="text" name="r_num" id="r_num" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="position: relative; top:-163px; left:240px; width:180px;">
									<label style="width: 180px;">单位：</label>
									<input type="text" name="g_unit" id="g_unit" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="position: relative; top:-163px; left:240px; width:180px;">
									<label style="width: 180px;">退货日期：</label>
									<input type="text" name="r_date" id="r_date" class="input-xlarge" style="width: 180px;">
								</li>
