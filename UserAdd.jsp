...
<%@ include file="navbar.jsp" %>
    <div class="content">
        ...
        <div class="container-fluid">
 			<div class="row-fluid">     
 			<form id="userTab" method="post" action="AddUserServlert" >
					...
					<div id="myTabContent">					
							<ul style="list-style: none; position: relative; left: -20px; height: 200px; width:180px;">
								...
								<li style="width:180px;">
									<label style="width: 180px;">用户id：</label>
									<input type="text" name="id" id="id" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="width:180px;">
									<label style="width: 180px;">用户姓名：</label>
									<input type="text" name="userName" id="userName" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="width:180px;">
									<label style="width: 180px;">用户电话：</label>
									<input type="text" name="phoneNum" id="phoneNum"  class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="position: relative; top:-163px; left:240px; width:180px;">
									<label style="width: 180px;">用户密码：</label>
									<input type="text" name="password" id="password" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="position: relative; top:-163px; left:240px; width:180px;">
									<label style="width: 180px;">是否为管理员：</label>
									<input type="text" name="isAdmain" id="isAdmain" class="input-xlarge" style="width: 180px;">
								</li>
