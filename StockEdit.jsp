...
<%@ include file="navbar.jsp" %>
 <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
    <div class="content">
        <div class="header">
            <h1 class="page-title">修改库存</h1>
        </div>
		<div>
			<ul class="breadcrumb">
				<li><a href="GetStockServlert">查看库存</a> <span class="divider">/</span></li>
				<li class="active">修改库存</li>
			</ul>
		</div>
        <div class="container-fluid">
 			<div class="row-fluid">     
 				<form id="stockTab" method="post" action="EditStockServlert">
					...
					<div id="myTabContent">					
							<ul style="list-style: none; position: relative; left: -20px; height: 200px; width:180px;">
								<li style="width:180px;">
									...
									<input type="text" name="g_name" id="g_name" value="${stock.g_name}" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="width:180px;">
									<label style="width: 180px;">商品条形码：</label>
									<input type="text"  readonly="readonly" name="g_barCode" id="g_barCode" value="${stock.g_barCode}" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="width:180px;">
									<label style="width: 180px;">保质期：</label>
									<input type="text" name="g_shelfLife" id="g_shelfLife" value="${stock.g_shelfLife}" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="width:180px;">
									<label style="width: 180px;">商品类型：</label>
									<input type="text" name="g_type" id="g_type" value="${stock.g_type}" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="width:180px;">
									<label style="width: 180px;">库存数量：</label>
									<input type="text" name="s_num" id="s_num" value="${stock.s_num}" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="width:180px;">
									<label style="width: 180px;">单位：</label>
									<input type="text" name="g_nuit" id="g_nuit" value="${stock.g_nuit}" class="input-xlarge" style="width: 180px;">
								</li>
								
								<li style="width:180px;">
									<label style="width: 180px;">是否过期：</label>
									<input type="text" name="g_lsexpired" id="g_lsexpired" value="${stock.g_lsexpired}" class="input-xlarge" style="width: 180px;">
								</li>
